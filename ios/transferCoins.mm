...
RCT_EXPORT_METHOD(sendCoins:(NSString* )recipient withAmount:(NSNumber* _Nonnull) amount withOts:(NSNumber* _Nonnull ) otsIndex withFee: (NSNumber* _Nonnull) fee withIndex:(NSString*)walletindex callback:(RCTResponseSenderBlock)callback)
{
